        ...
        <div class="product-section">
            <div class="container">
                <div class="section-header" data-aos="fade-up">
                    ...
                    <h2>Heat Pump Solutions</h2>
                    <p>High-efficiency York heat pumps designed for sustainable heating and cooling in diverse
                        applications.</p>
                </div>

                <!-- AIR-COOLED SECTION -->
                <div class="text-center" data-aos="fade-up">
                    <span class="category-label">Air-Cooled Heat Pumps</span>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <ul class="product-specs">
                                    ...
                                    <li>Efficient Heating for Small-Medium builds</li>
                                    <li>Compact Footprint</li>
                                </ul>
                                <div class="capacity-box">
                                    <span>Heating Capacity</span>
                                    <strong>46 kW and 66 kW</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="product-card">
                            <div class="product-badge">Advanced Control</div>
                            <div class="product-image-wrapper">
                            ...
                            <div class="product-info">
                                ...
                                <ul class="product-specs">
                                    ...
                                    <li>High Seasonal Performance</li>
                                </ul>
                                <div class="capacity-box">
                                    <span>Heating Capacity</span>
                                    <strong>145 kW</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="product-card">
                            <div class="product-badge">Sustainable Tech</div>
                            <div class="product-image-wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="product-card">
                            <div class="product-badge">Scroll Power</div>
                            <div class="product-image-wrapper">
                            ...
                            <div class="product-info">
                                ...
                                <ul class="product-specs">
                                    <li>Air-cooled Scroll Heat Pump</li>
                                    <li>R410A Refrigerant</li>
                                    <li>Reliable Heating Solutions</li>
                                    <li>Modular Configuration</li>
                                </ul>
                                <div class="capacity-box">
                                    <span>Heating Capacity</span>
                                    <strong>66 kW to 131.9 kW</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center mt-5" data-aos="fade-up">
                    <span class="category-label">Water-Cooled Heat Pumps</span>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="product-card">
                            <div class="product-badge">Internal Installation</div>
                            <div class="product-image-wrapper">
                            ...
                            <div class="product-info">
                                ...
                                <ul class="product-specs">
                                    <li>Water-Cooled Scroll Heat Pump</li>
                                    <li>R410A Refrigerant</li>
                                    <li>Optional: Factory Built Canopy</li>
                                    <li>Excellent Quiet Operation</li>
                                </ul>
                                <div class="capacity-box">
                                    <span>Heating Capacity</span>
                                    <strong>90.6 kW to 180.6 kW</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-header mt-5 pt-5" data-aos="fade-up">
                    ...
                    <p>Customizable modular solutions for superior indoor air quality and ventilation.</p>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="product-card">
                            <div class="product-badge">Modular Design</div>
                            <div class="product-image-wrapper" style="height: 400px;">
                                <img src="img/york/ymz modular ahu.png" alt="York YMZ Modular AHU">
                            </div>
                            <div class="product-info">
                                <h3 class="product-title text-center">YMZ Modular AHU</h3>
                                <p class="text-center text-muted mb-4">Optimized for reliability, performance, and easy
                                    installation in commercial buildings.</p>
                                <ul class="product-specs d-flex flex-wrap justify-content-center" style="gap: 20px;">
                                    <li><i class="fas fa-check-circle me-2"></i>Wide Airflow Range</li>
                                    <li><i class="fas fa-check-circle me-2"></i>Energy Efficient Fans</li>
                                    <li><i class="fas fa-check-circle me-2"></i>Superior Filtration</li>
                                </ul>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <div class="capacity-box text-center">
                                            <span>Airflow Range (m3/h)</span>
                                            <strong>1,000 - 100,000</strong>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="capacity-box text-center">
                                            <span>Airflow Range (CFM)</span>
                                            <strong>589 - 58,860</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
